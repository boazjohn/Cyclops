...
//System.out.println("xxx  = = "+xx);
                 ...
                 <span class="box_box"> <img src="imagepool/<%=xx%>" alt="<%=xx%>">
                        <div class="tippy" style="display: none;"> <table><tr><td><img src="imagepool/<%=xx%>" alt="<%=xx%>" class="image_preview" /></td><td><table><tr><td>
                                                    Filename: <%=name%></td></tr><tr><td>Links: <%=xx%></td></tr><tr><td>Details: <%=descr%></td></tr><tr><td>Comments: <%=other%></td></tr><tr><td>Tags: <%=tags%></td></tr></table></td></tr></table><table><tr><td><a class="tiplink" href="edit-details.jsp?e=<%=img_id%>">Edit</a></td><td><a href="review.jsp?q=<%=img_id%>" class="tiplink">Review</a></td></tr></table></div></span>
                    <%   tags = "";
