...
<html>
    ...
    %>
    <div class="wrapper">
        <div class="tagtop"> Upload a New Image: Enter Details</div>
        <div class="search_box3">
            ...
            <div class="img_upload_details"> <table>
                <form name="upload" action="uploaded-image.jsp" method="POST">
                    ...
                    <div  class="search_img_upload_thumb_details"><span class="bigtexts">Image suggestion:</span> <%
                    if(gxx!=null) {
                    %> <br><img src="imagepool/<%=gxx%>" alt="<%=gxx%>">
                    <% }
                    else
                      {
                    ...
                    <img src="searchimg/default.jpg" height="120"/>
