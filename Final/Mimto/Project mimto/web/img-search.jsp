                                                                                               ...
                                                                                               Random r = new Random();
                                                                                                ...
                                                                                                for(int pp = 0;pp<tagdisp.size()&&pp<tagweight.size();pp++)
                                                                                                   ...
                                                                                                   System.out.println("Val = "+tagdisp.get(pp).toString()+" wt = "+tagweight.get(pp).toString());
                                                                                                    if(pp%4==0)
                                                                                                        out.print(" <span style=\"font-size:"+tagweight.get(pp).toString()+"px; margin:"+r.nextInt(30)+"px; \"><a href=\"get-img-tag.jsp?t="+tagdisp.get(pp).toString()+"\">"+tagdisp.get(pp).toString()+"</a></span> <br>");
                                                                                                    else
                                                                                                        out.print(" <span style=\"font-size:"+tagweight.get(pp).toString()+"px; margin:"+r.nextInt(30)+"px; \"><a href=\"get-img-tag.jsp?t="+tagdisp.get(pp).toString()+"\">"+tagdisp.get(pp).toString()+"</a></span> ");
                                                                                                    }
                                                                                            } catch (Exception e) {
