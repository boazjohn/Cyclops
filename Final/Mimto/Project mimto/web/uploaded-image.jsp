...
<!--
setTimeout("location.href = 'admin-panel.jsp';",2000);
-->
</script>
        <div class="wrapper">

            <div class="search_box2">
        <img src="imagepool/<%=fname%>" alt="<%=fname%>" class="upload_thumb_top" /><div class="tagtop"> Uploaded Image. Now redirecting back to cPanel.</div>
</div>
